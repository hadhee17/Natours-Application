...
var displayMap = exports.displayMap = function displayMap(location) {
  var map = L.map('map', {
    zoomControl: false
  }); //to disable + - zoom
...
if (mapBox) {
  var location = JSON.parse(mapBox.dataset.locations);
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "64028" + '/');
