...
},{"./alert":"acK6"}],"nb4k":[function(require,module,exports) {
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.VERSION=void 0;const e=exports.VERSION="1.11.0";
...
},{"./lib/axios.js":"HXpE"}],"UUNB":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.loadStripe=void 0;var e,r="basil",t=function(e){return 3===e?"v3":e},n="https://js.stripe.com",o="".concat(n,"/").concat(r,"/stripe.js"),i=/^https:\/\/js\.stripe\.com\/v3\/?(\?.*)?$/,s=/^https:\/\/js\.stripe\.com\/(v3|[a-z]+)\/stripe\.js(\?.*)?$/,a="loadStripe.setLoadParameters was called but an existing Stripe.js script already exists in the document; existing script parameters will be used",c=function(e){return i.test(e)||s.test(e)},u=function(){for(var e=document.querySelectorAll('script[src^="'.concat(n,'"]')),r=0;r<e.length;r++){var t=e[r];if(c(t.src))return t}return null},l=function(e){var r=e&&!e.advancedFraudSignals?"?advancedFraudSignals=false":"",t=document.createElement("script");t.src="".concat(o).concat(r);var n=document.head||document.body;if(!n)throw new Error("Expected document.body not to be null. Stripe.js requires a <body> element.");return n.appendChild(t),t},d=function(e,r){e&&e._registerWrapper&&e._registerWrapper({name:"stripe-js",version:"7.9.0",startTime:r})},p=null,f=null,v=null,m=function(e){return function(r){e(new Error("Failed to load Stripe.js",{cause:r}))}},w=function(e,r){return function(){window.Stripe?e(window.Stripe):r(new Error("Stripe.js not available"))}},h=function(e){return null!==p?p:(p=new Promise(function(r,t){if("undefined"!=typeof window&&"undefined"!=typeof document)if(window.Stripe&&e&&console.warn(a),window.Stripe)r(window.Stripe);else try{var n=u();if(n&&e)console.warn(a);else if(n){if(n&&null!==v&&null!==f){var o;n.removeEventListener("load",v),n.removeEventListener("error",f),null===(o=n.parentNode)||void 0===o||o.removeChild(n),n=l(e)}}else n=l(e);v=w(r,t),f=m(t),n.addEventListener("load",v),n.addEventListener("error",f)}catch(i){return void t(i)}else r(null)})).catch(function(e){return p=null,Promise.reject(e)})},j=function(e,n,o){if(null===e)return null;var i=n[0].match(/^pk_test/),s=t(e.version),a=r;i&&s!==a&&console.warn("Stripe.js@".concat(s," was loaded on the page, but @stripe/stripe-js@").concat("7.9.0"," expected Stripe.js@").concat(a,". This may result in unexpected behavior. For more information, see https://docs.stripe.com/sdks/stripejs-versioning"));var c=e.apply(void 0,n);return d(c,o),c},S=!1,y=function(){return e||(e=h(null).catch(function(r){return e=null,Promise.reject(r)}))};Promise.resolve().then(function(){return y()}).catch(function(e){S||console.warn(e)});var b=exports.loadStripe=function(){for(var e=arguments.length,r=new Array(e),t=0;t<e;t++)r[t]=arguments[t];S=!0;var n=Date.now();return y().then(function(e){return j(e,r,n)})};
},{}],"BFn4":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=require("../dist/index.mjs");Object.keys(e).forEach(function(t){"default"!==t&&"__esModule"!==t&&(t in exports&&exports[t]===e[t]||Object.defineProperty(exports,t,{enumerable:!0,get:function(){return e[t]}}))});
},{"../dist/index.mjs":"UUNB"}],"Uj2q":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.bookTour=void 0;var t=n(require("axios")),r=require("@stripe/stripe-js"),e=require("./alert");function n(t){return t&&t.__esModule?t:{default:t}}function o(){var t,r,e="function"==typeof Symbol?Symbol:{},n=e.iterator||"@@iterator",u=e.toStringTag||"@@toStringTag";function c(e,n,o,u){var c=n&&n.prototype instanceof f?n:f,s=Object.create(c.prototype);return i(s,"_invoke",function(e,n,o){var i,u,c,f=0,s=o||[],p=!1,l={p:0,n:0,v:t,a:v,f:v.bind(t,4),d:function(r,e){return i=r,u=0,c=t,l.n=e,a}};function v(e,n){for(u=e,c=n,r=0;!p&&f&&!o&&r<s.length;r++){var o,i=s[r],v=l.p,y=i[2];e>3?(o=y===n)&&(c=i[(u=i[4])?5:(u=3,3)],i[4]=i[5]=t):i[0]<=v&&((o=e<2&&v<i[1])?(u=0,l.v=n,l.n=i[1]):v<y&&(o=e<3||i[0]>n||n>y)&&(i[4]=e,i[5]=n,l.n=y,u=0))}if(o||e>1)return a;throw p=!0,n}return function(o,s,y){if(f>1)throw TypeError("Generator is already running");for(p&&1===s&&v(s,y),u=s,c=y;(r=u<2?t:c)||!p;){i||(u?u<3?(u>1&&(l.n=-1),v(u,c)):l.n=c:l.v=c);try{if(f=2,i){if(u||(o="next"),r=i[o]){if(!(r=r.call(i,c)))throw TypeError("iterator result is not an object");if(!r.done)return r;c=r.value,u<2&&(u=0)}else 1===u&&(r=i.return)&&r.call(i),u<2&&(c=TypeError("The iterator does not provide a '"+o+"' method"),u=1);i=t}else if((r=(p=l.n<0)?c:e.call(n,l))!==a)break}catch(r){i=t,u=1,c=r}finally{f=1}}return{value:r,done:p}}}(e,o,u),!0),s}var a={};function f(){}function s(){}function p(){}r=Object.getPrototypeOf;var l=[][n]?r(r([][n]())):(i(r={},n,function(){return this}),r),v=p.prototype=f.prototype=Object.create(l);function y(t){return Object.setPrototypeOf?Object.setPrototypeOf(t,p):(t.__proto__=p,i(t,u,"GeneratorFunction")),t.prototype=Object.create(v),t}return s.prototype=p,i(v,"constructor",p),i(p,"constructor",s),s.displayName="GeneratorFunction",i(p,u,"GeneratorFunction"),i(v),i(v,u,"Generator"),i(v,n,function(){return this}),i(v,"toString",function(){return"[object Generator]"}),(o=function(){return{w:c,m:y}})()}function i(t,r,e,n){var o=Object.defineProperty;try{o({},"",{})}catch(t){o=0}(i=function(t,r,e,n){function u(r,e){i(t,r,function(t){return this._invoke(r,e,t)})}r?o?o(t,r,{value:e,enumerable:!n,configurable:!n,writable:!n}):t[r]=e:(u("next",0),u("throw",1),u("return",2))})(t,r,e,n)}function u(t,r,e,n,o,i,u){try{var c=t[i](u),a=c.value}catch(t){return void e(t)}c.done?r(a):Promise.resolve(a).then(n,o)}function c(t){return function(){var r=this,e=arguments;return new Promise(function(n,o){var i=t.apply(r,e);function c(t){u(i,n,o,c,a,"next",t)}function a(t){u(i,n,o,c,a,"throw",t)}c(void 0)})}}var a=exports.bookTour=function(){var r=c(o().m(function r(n){var i,u,c;return o().w(function(r){for(;;)switch(r.p=r.n){case 0:return r.p=0,r.n=1,(0,t.default)("http://127.0.0.1:3000/api/v1/bookings/checkout-session/".concat(n));case 1:i=r.v,u=i.data.session.url,window.location.assign(u),r.n=3;break;case 2:r.p=2,c=r.v,console.error("Booking failed:",c),(0,e.showAlert)("error",c);case 3:return r.a(2)}},r,null,[[0,2]])}));return function(t){return r.apply(this,arguments)}}();
